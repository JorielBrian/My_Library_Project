...
const Header = () => {
    ...
    return ( 
        <header className='flex sticky top-0 w-full h-20 z-10 justify-between pt-3 px-10 backdrop-blur-sm rounded-b-xl'>
            <div id='title' className='heading-title group flex w-5/8 md:w-2/3 lg:w-5/12'>
                <h1 className='w-[90px] sm:w-[150px] text-4xl sm:text-6xl font-bold overflow-hidden group-hover:w-auto'>Joriel's</h1>
                <h1 className='w-[19px] sm:w-9 text-4xl sm:text-6xl text-yellow-400 font-bold overflow-hidden group-hover:w-auto'>Library</h1>
            </div>
            <nav className='sm:flex relative w-3/8 md:w-2/3 lg:1/2 mt-3 text-orange-800'>
                <form onSubmit={onSearch} ref={searchbar} className="hidden absolute sm:block sm:static sm:w-5/6 md:1/3 lg:w-5/12 h-2/3 m-2 top-20 right-0">
                ...
                <div ref={navigation} className="hidden absolute w-[60vw] md:w-full m2 flex-col lg:flex lg:flex-row top-32 sm:top-12 lg:top-0 right-0 2xl:right-16 items-center justify-evenly text-lg text-white font-semibold lg:w-1/2">
