...
const Welcome = () => {
    return (
        <main className="flex flex-col w-full text-center h-[55vh]">
            ...
            <Link href='/books' className="w-1/2 p-2 mx-auto my-5 font-bold bg-orange-400 border-8 border-orange-700 rounded-md hover:bg-orange-600 hover:scale-110 active:bg-orange-800">Go to Books</Link>
        </main>
    );
}
